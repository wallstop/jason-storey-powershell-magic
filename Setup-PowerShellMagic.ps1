...
$Dependencies = @{
    'fzf' = @{
        ...
        PortableAssets = @{
            Windows = @{
                Url = 'https://github.com/junegunn/fzf/releases/download/v0.68.0/fzf-0.68.0-windows_amd64.zip'
                Sha256 = '4939ED89F3A75258EA47C55C34422B6B3F28E38B85DBD1E27DC4CF5839D5D310'
                Executable = 'fzf.exe'
                ArchiveType = 'zip'
            }
        }
