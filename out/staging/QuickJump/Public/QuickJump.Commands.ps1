    ...
    process {
        ...
        Invoke-QuickJumpAtomicUpdate -UpdateScriptBlock {
            ...
            if ($existingAliasEntry) {
                ...
                Write-Verbose "Updated path entry: $capturedPathStr"
                ...
                Write-Verbose "Added path entry: $capturedPathStr"
            }

            if ($capturedAlias) { Write-Verbose "  Alias: $capturedAlias" }
            if ($capturedCategory) { Write-Verbose "  Category: $capturedCategory" }
